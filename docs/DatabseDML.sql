...
INSERT INTO public.item (
  item_id, item_name, item_code, supplier_id, enable_flag, created_at, created_by
)
VALUES
	(1,'Khẩu trang y tế','MASK',1,TRUE,CURRENT_TIMESTAMP,1),
	(2,'Găng tay y tế','GLOVE',1,TRUE,CURRENT_TIMESTAMP,1),
	(3,'Dung dịch sát khuẩn','SANITIZER',1,TRUE,CURRENT_TIMESTAMP,1);
